...
import { BaseService, ServiceError, AuditAction, AuditStatus } from './base.service';
...
class MockService extends BaseService<MockDoc, MockRepo> {
    public testValidateId(id: any) { return this.validateId(id); }
    public testValidateEnum(v: any, vals: any, f: string) { return this.validateEnum(v, vals, f); }
    public testValidateRequired(d: any, f: string[]) { return this.validateRequired(d, f); }
    public testLogAction(u: string, a: AuditAction, s: AuditStatus, r: any, d?: any) { return this.logAction(u, a, s, r, d); }
    public testHandleError(e: any) { return this.handleRepositoryError(e); }
}
...
describe('BaseService', () => {
    ...
    describe('validateEnum', () => {
        ...
        it('should throw if invalid', () => {
            expect(() => service.testValidateEnum('C', ['A', 'B'], 'field')).toThrow(ServiceError);
        });
    });
    ...
    describe('validateRequired', () => {
        ...
        it('should throw if missing', () => {
            expect(() => service.testValidateRequired({ a: '' }, ['a'])).toThrow(ServiceError);
        });
    });
    ...
    describe('handleRepositoryError', () => {
        ...
        it('should handle duplicate key', () => {
            const error = new RepositoryError('Dup', RepositoryErrorCode.DUPLICATE_KEY);
            try {
                service.testHandleError(error);
            } catch (e: any) {
        ...
        it('should handle unknown errors', () => {
            expect(() => service.testHandleError(new Error('Panic'))).toThrow(ServiceError);
        });
    });
});
