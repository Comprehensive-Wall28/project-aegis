...
describe('NotesService', () => {
  ...
  describe('getContent', () => {
    it('should return buffer and note', async () => {
      ...
      mockGridFsService.downloadToBuffer.mockResolvedValue(
        Buffer.from('content'),
      );
  ...
  describe('updateContent', () => {
    ...
    it('should update content and cleanup old file', async () => {
      ...
      mockNoteRepository.updateOne.mockResolvedValue({
        ...mockNote,
        gridFsFileId: 'new_file_id',
      });
    ...
    it('should cleanup new file and throw if update fails', async () => {
      ...
      await expect(
        service.updateContent(noteId, userId, updateDto),
