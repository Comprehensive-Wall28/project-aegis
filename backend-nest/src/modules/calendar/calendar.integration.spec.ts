...
describe('CalendarModule (Integration)', () => {
    ...
    it('should create an event', async () => {
        ...
        const event = await calendarService.createEvent(userId.toHexString(), {
    ...
    it('should filter events by date range', async () => {
        ...
        await calendarService.createEvent(userId.toHexString(), {
            encryptedData: 'ev1',
            encapsulatedKey: 'k',
    ...
    it('should delete an event', async () => {
        ...
        expect(events.find(e => (e as any)._id.toString() === id)).toBeUndefined();
    });
});
