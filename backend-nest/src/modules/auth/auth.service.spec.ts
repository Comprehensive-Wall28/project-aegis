...
describe('AuthService Unit Tests', () => {
    ...
    describe('register', () => {
        ...
        it('should reject missing required fields', async () => {
            ...
            await expect(authService.register(incompleteDto)).rejects.toThrow(BadRequestException);
        });
    });
    ...
    describe('login', () => {
        ...
        it('should login with v2 hash and return user data', async () => {
            ...
            expect(usersRepository.findByEmail).toHaveBeenCalledWith('test@example.com');
            expect(argon2.verify).toHaveBeenCalledWith('hashed-password', 'client-hash');
        ...
        it('should reject invalid credentials', async () => {
            ...
            await expect(authService.login(loginDto, undefined)).rejects.toThrow(UnauthorizedException);
        ...
        it('should migrate v1 hash to v2 on successful login with legacyHash', async () => {
            ...
            expect(argon2.verify).toHaveBeenCalledWith('hashed-password', 'legacy-hash');
            expect(argon2.hash).toHaveBeenCalledWith('client-hash');
    ...
    describe('getMe', () => {
        ...
        it('should throw error for non-existent user', async () => {
            ...
            await expect(authService.getMe('non-existent-id')).rejects.toThrow(BadRequestException);
        });
    });
    ...
    describe('discoverUser', () => {
        ...
        it('should throw error for non-existent user', async () => {
            ...
            await expect(authService.discoverUser('nonexistent@example.com')).rejects.toThrow(
                BadRequestException
            );
        });

        it('should require email parameter', async () => {
            await expect(authService.discoverUser('')).rejects.toThrow(BadRequestException);
        });
    });
    ...
    describe('updateProfile', () => {
        it('should update profile and log audit event', async () => {
            ...
            expect(usersService.updateProfile).toHaveBeenCalledWith(mockUser._id, updateDto);
            expect(auditService.logAuditEvent).toHaveBeenCalledWith(
                mockUser._id,
                'PROFILE_UPDATE',
                'SUCCESS',
    ...
    describe('formatUserResponse', () => {
        ...
        it('should handle user without preferences', async () => {
            ...
            (usersRepository.findById as jest.Mock).mockResolvedValue(userWithoutPrefs);
