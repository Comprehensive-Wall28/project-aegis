...
export class AnalyticsBufferService implements OnApplicationShutdown {
    ...
    private async flushMetrics(): Promise<void> {
        ...
        try {
            ...
            this.logger.error('Failed to flush metrics batch', { error, batchSize: batch.length });
        } finally {
    ...
    private async flushLogs(): Promise<void> {
        ...
        try {
            ...
            this.logger.error('Failed to flush logs batch', { error, batchSize: batch.length });
        } finally {
            this.isFlushing = false;
        }
    }
    ...
    private async getModel(name: string, schema: any): Promise<Model<any> | null> {
        ...
        try {
            ...
            return (this.databaseManager as any).secondaryConnection?.model(name, schema) || null;
        } catch (e) {
            return null;
        }
    }
