...
describe('GpaController', () => {
    ...
    describe('createCourse', () => {
        it('should call createCourse with correct parameters', async () => {
            ...
            expect(service.createCourse).toHaveBeenCalledWith('user_id', dto, mockRequest);
        });
    });
    ...
    describe('deleteCourse', () => {
        it('should call deleteCourse with correct parameters', async () => {
            ...
            expect(service.deleteCourse).toHaveBeenCalledWith('user_id', id, mockRequest);
        });
    });
    ...
    describe('updatePreferences', () => {
        it('should call updatePreferences with correct parameters', async () => {
            ...
            expect(service.updatePreferences).toHaveBeenCalledWith('user_id', '4.0', mockRequest);
        });
    });
});
