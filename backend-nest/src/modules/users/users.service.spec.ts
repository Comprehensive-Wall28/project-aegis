...
describe('UsersService', () => {
    ...
    describe('findByEmail', () => {
        it('should call repository findByEmail', async () => {
            ...
            expect(mockUsersRepository.findByEmail).toHaveBeenCalledWith('test@ex.com');
        });
    });
    ...
    describe('updateProfile', () => {
        ...
        it('should update profile successfully', async () => {
            ...
            mockUsersRepository.updateById.mockResolvedValue({ ...existingUser, username: 'new' });
        ...
        it('should throw if username is taken by another user', async () => {
            ...
            await expect(service.updateProfile(userId, { username: 'taken' })).rejects.toThrow('Username already taken');
        });
        ...
        it('should throw if email is taken by another user', async () => {
            ...
            await expect(service.updateProfile(userId, { email: 'taken@ex.com' })).rejects.toThrow('Email already taken');
        });
        ...
        it('should throw if updateById fails', async () => {
            ...
            await expect(service.updateProfile(userId, { username: 'new' })).rejects.toThrow('Failed to update profile');
        });
    });
