...
describe('GridFsService', () => {
    ...
    describe('uploadBuffer', () => {
        it('should upload buffer and return ObjectId', async () => {
            ...
            const resultPromise = service.uploadBuffer(Buffer.from('test'), 'test.txt');
            ...
            expect(mockBucketInstance.openUploadStream).toHaveBeenCalledWith('test.txt', { metadata: undefined });
        });
    });
    ...
    describe('downloadToBuffer', () => {
        it('should download to buffer', async () => {
            ...
            expect(mockBucketInstance.openDownloadStream).toHaveBeenCalledWith(fileId);
        });
    });
