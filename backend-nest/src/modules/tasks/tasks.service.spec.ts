...
describe('TasksService', () => {
  ...
  describe('create', () => {
    it('should create a task with calculated order', async () => {
      ...
      expect(mockTaskRepository.getMaxOrderInColumn).toHaveBeenCalledWith(
        userId,
        'todo',
      );
  ...
  describe('update', () => {
    ...
    it('should throw NotFoundException if update fails', async () => {
      ...
      await expect(service.update('id', 'uid', {})).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('reorder', () => {
    it('should call repository.reorderBulk', async () => {
      ...
      expect(mockTaskRepository.reorderBulk).toHaveBeenCalledWith(
        'uid',
        updates,
      );
    });
