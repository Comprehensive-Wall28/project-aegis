...
describe('FoldersController (E2E)', () => {
    ...
    const mockFolderModel = {
        ...
        findOneAndUpdate: jest.fn().mockImplementation(() => createMockQuery(mockFolder)),
        findOneAndDelete: jest.fn().mockImplementation(() => createMockQuery(mockFolder)),
        findByIdAndUpdate: jest.fn().mockImplementation(() => createMockQuery(mockFolder)),
        findByIdAndDelete: jest.fn().mockImplementation(() => createMockQuery(mockFolder)),
