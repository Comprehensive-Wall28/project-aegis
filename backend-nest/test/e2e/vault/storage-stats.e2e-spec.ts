...
describe('Vault Storage Stats (e2e) - GET /api/vault/storage-stats', () => {
    ...
    beforeAll(async () => {
        ...
        userModel = moduleFixture.get<Model<UserDocument>>(getModelToken(User.name, 'primary'));
    });
    ...
    it('should return updated storage stats after manual update', async () => {
        ...
        await userModel.findByIdAndUpdate(userId, { totalStorageUsed: mockUsedStorage });
