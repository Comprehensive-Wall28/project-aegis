...
export abstract class BaseRepository<T extends Document> {
    ...
    protected dbInstance: string;

    constructor(model: Model<T>, dbInstance: string = 'primary') {
        this.model = model;
    ...
    async findOne(filter: SafeFilter<T>, options: QueryOptions = {}): Promise<T | null> {
        ...
        try {
            ...
            logger.error(`Repository findOne error:`, error);
            throw new RepositoryError(
    ...
    async updateById(
        ...
        try {
            ...
            logger.error(`Repository updateById error:`, error);
            throw new RepositoryError(
    ...
    async updateOne(
        ...
        try {
            ...
            logger.error(`Repository updateOne error:`, error);
            throw new RepositoryError(
                'Failed to update document',
                RepositoryErrorCode.QUERY_ERROR,
                error
    ...
    async updateMany(filter: SafeFilter<T>, data: UpdateQuery<T>): Promise<number> {
        ...
        try {
            ...
            logger.error(`Repository updateMany error:`, error);
            throw new RepositoryError(
    ...
    async deleteById(id: string): Promise<boolean> {
        ...
        try {
            ...
            logger.error(`Repository deleteById error:`, error);
            throw new RepositoryError(
    ...
    async deleteOne(filter: SafeFilter<T>): Promise<boolean> {
        ...
        try {
            const result = await this.model.findOneAndDelete(sanitizedFilter as any).exec();
            return result !== null;
        } catch (error) {
            logger.error(`Repository deleteOne error:`, error);
            throw new RepositoryError(
                'Failed to delete document',
                RepositoryErrorCode.QUERY_ERROR,
                error
    ...
    async deleteMany(filter: SafeFilter<T>): Promise<number> {
        ...
        try {
            ...
            logger.error(`Repository deleteMany error:`, error);
            throw new RepositoryError(
    ...
    async bulkWrite(operations: BulkWriteOperation<T>[]): Promise<BulkWriteResult> {
        ...
        try {
            ...
            logger.error(`Repository bulkWrite error:`, error);
            throw new RepositoryError(
    ...
    async aggregate<R>(pipeline: object[]): Promise<R[]> {
        ...
        try {
            ...
            logger.error(`Repository aggregate error:`, error);
            throw new RepositoryError(
    ...
    async exists(filter: SafeFilter<T>): Promise<boolean> {
        ...
        try {
            ...
            logger.error(`Repository exists error:`, error);
            throw new RepositoryError(
